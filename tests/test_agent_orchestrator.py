...
def test_foundation_confirmation_promotes_drafts_and_advances_to_rolling_outline(
    ...
    assert (planning_store.story_src_dir / "background.md").read_text(encoding="utf-8") == "背景A"
    assert (planning_store.story_src_dir / "foundation.md").read_text(encoding="utf-8") == "设定B"
