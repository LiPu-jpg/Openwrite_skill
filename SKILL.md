...
| 对话式创建项目 | [skills/goethe-agent/SKILL.md](./skills/goethe-agent/SKILL.md) | 启动引导 |
...
```text
craft/                                  -> 通用写作技法
data/reference_styles/{作品名}/         -> 参考作品风格摘录
